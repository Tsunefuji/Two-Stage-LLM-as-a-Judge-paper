...
- `required_items_generation_turn1.md`: Prompt for generating required criteria (Turn 1)
- `required_items_generation_turn2.md`: Prompt for generating required criteria (Turn 2)
- `bonus_items_generator_turn1.md`: Prompt for generating bonus criteria (Turn 1)
- `bonus_items_generator_turn2.md`: Prompt for generating bonus criteria (Turn 2)
